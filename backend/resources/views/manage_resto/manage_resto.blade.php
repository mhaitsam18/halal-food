...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Resto Saya</div>
            <div class="ps-3">
            ...
            <div class="main-body">
                <div class="col-lg-9">
                    <div class="row row-cols-1 row-cols-md-3 g-4">
                        @foreach ($claimed_resto as $item)
                        <div class="col d-flex align-items-stretch">
                            <div class=" card">
                                @if ($item->Restaurant->Image->first())
                                <a class="text-black" href="/restaurant/manage/{{str_replace(' ', '-', $item->Restaurant->Area->name)}}/{{str_replace(' ', '-', $item->Restaurant->name)}}/{{$item->Restaurant->id}}">
                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex bd-highlight">
                                        <div class="p-2 flex-grow-1 bd-highlight">
                                            <h6 class="card-title cursor-pointer"><b><a class="text-black" href="/restaurant/manage/{{str_replace(' ', '-', $item->Restaurant->Area->name)}}/{{str_replace(' ', '-', $item->Restaurant->name)}}/{{$item->Restaurant->id}}">{{$item->Restaurant->name}}</a></b></h6>
                                        </div>
