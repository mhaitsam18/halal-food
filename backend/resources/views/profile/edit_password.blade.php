					...
					<div class="main-body">
						<div class="row">
									...
									<div class="card-body">
										...
										<ul class="list-group list-group-flush">
											<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
												<i data-feather="shopping-bag" style="color: #670075;"></i></span><h6>Cari Resto saya</h6>
												<i data-feather="chevron-right" style="color:#670075"></i>
											</li>
											<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
												<i data-feather="users" style="color:#670075"></i></span><h6>Kontributor</h6>
												<i data-feather="chevron-right" style="color:#670075"></i>
											</li>
											<li class="list-group-item">
												<a href="/profile/edit-password/{{Crypt::encryptString(Auth::user()->id)}}" class="d-flex justify-content-between align-items-center flex-wrap">
													<i data-feather="shield" style="color:#670075"></i></span><h6>Ganti Kata Sandi</h6>
													<i data-feather="chevron-right" style="color:#670075"></i>
												</a>
											</li>
											<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal">
												<i data-feather="log-out" style="color: #670075;"></i></span><h6>Keluar</h6>
												<i data-feather="chevron-right" style="color:#670075"></i>
											</li>
										</ul>
									</div>
							...
							<div class="col-lg-8">
								<div class="card">
									<div class="card-body">
										<h4 style="color: #670075;">Ganti Kata Sandi</h4>
                                        <input hidden type="text" value="{{$user->id}}" id="user_id" name="user_id" >
                                        <form class="row" id="form" action="/profile/edit-password/{{Crypt::encryptString(Auth::user()->id)}}" method="post" enctype="multipart/form-data">
                                        @csrf   
											<div class="row mb-3 mt-3">
												<div class="col-sm-3">
													<h6 class="mb-0"><b>Kata sandi lama</b><span class="text-danger"> *</span></h6>
												</div>
												<div class="col-sm-9 text-secondary">
													<div class="input-group" id="show_hide_password">
														<input type="password" name="old_password" class="form-control form-input @error('old_password') is-invalid @enderror" placeholder="Masukkan kata sandi lama" />
											...
											<div class="row mb-3">
												<div class="col-sm-3">
													<h6 class="mb-0"><b>Kata sandi baru</b><span class="text-danger"> *</span></h6>
													<div class="text-secondary">Minimal 8 karakter kombinasi huruf besar, huruf kecil, dan angka.</div>
												</div>
												<div class="col-sm-9 text-secondary">
													<div class="input-group" id="show_hide_password">
														<input type="password" name="new_password" class="form-control form-input @error('new_password') is-invalid @enderror" placeholder="Masukkan kata sandi baru" />
														<a href="javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>
														@error('new_password')
															<div class="invalid-feedback">
																{{ $message }}
											...
											<div class="row mb-3">
												<div class="col-sm-3">
													<h6 class="mb-0"><b>Konfirmasi kata sandi</b><span class="text-danger"> *</span></h6>
												</div>
												<div class="col-sm-9 text-secondary">
													<div class="input-group" id="show_hide_password">
														<input type="password" name="confirm_password" class="form-control form-input @error('confirm_password') is-invalid @enderror" placeholder="Masukkan konfirmasi kata sandi" />
														<a href="javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>
