        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" style="color: #202020" aria-current="page">
                                <a href="/report-restaurant">Pengaduan Sertifikasi</a>
                            </li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <!-- Modal Lihat Main -->
                    <div class=" modal fade" id="RestoPhoto{{ $report->restaurant->Image->first()->id }}"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header d-block" style="border: none">
                                ...
                                <div class="modal-footer" style="border: none">
                                    <button type="button" class="btn btn-primary mx-auto d-block" style="width:90%;"
